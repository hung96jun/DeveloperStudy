...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   //const Vector2 screenSize = { GetSystemMetrics(SM_CXSCREEN) , GetSystemMetrics(SM_CYSCREEN) };
   //const int windowX = (screenSize.x - WIN_WIDTH) / 2;
   //const int windowY = (screenSize.y - WIN_HEIGHT) / 2;
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_MOUSEMOVE:
    {
        ...
        mousePos.Y = (float)WIN_HEIGHT - (float)HIWORD(lParam);
        GameInstance::SetMousePos(mousePos);
    }
        break;
    case WM_DESTROY:
        PostQuitMessage(0);
